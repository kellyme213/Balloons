...
fragment float4 fragmentShader(RasterizerData in [[stage_in]],
  ...
  if (in.mycolor.x > 0.35 && in.mycolor.y > 0.35 && in.mycolor.z > 0.35) {
     MaterialDiffuseColor = vector_float3(1,1,1);
  } else if (in.mycolor.x > 0.1 && in.mycolor.x == in.mycolor.y && in.mycolor.x == in.mycolor.z) {
     MaterialDiffuseColor = vector_float3(1,1,1);
  } else {
